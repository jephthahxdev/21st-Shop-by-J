...
if ( empty( $icon ) || strpos( $icon, 'fa-heart-o' ) || strpos( $icon, 'fa-heart' ) ) {
	$icon = \Durotan\Icon::get_svg( 'heart-2', '', 'shop' );
}
?>

<!-- ADDED TO WISHLIST MESSAGE -->
<a class="yith-wcwl-wishlistaddedbrowse durotan-loop_button" href="<?php echo esc_url( $wishlist_url ); ?>" rel="nofollow" data-text="<?php echo esc_attr($browse_wishlist_text); ?>">
