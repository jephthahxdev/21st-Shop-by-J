...
echo apply_filters(
	...
	sprintf(
		'<a href="%s" data-product_id="%d" class="%s" aria-label="%s" role="button" data-text="%s" data-product-title="%s">
			%s
		...
		esc_attr( isset( $args['aria-label'] ) ? $args['aria-label'] : sprintf( __( 'Compare %s', 'durotan' ), '&ldquo;' . $product->get_title() . '&rdquo;' ) ),
		esc_html( isset( $args['label'] ) ? $args['label'] : __( 'Compare', 'durotan' ) ),
		$product->get_title(),
