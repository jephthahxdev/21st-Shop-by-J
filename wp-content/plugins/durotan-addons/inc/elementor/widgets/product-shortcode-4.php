 ...
 */
class Product_Shortcode_4 extends Widget_Base {
	/**
	...
	public function get_name() {
		return 'durotan-product-shortcode-4';
	}
	...
	public function get_title() {
		return esc_html__( 'Durotan - Product Shortcode 4', 'durotan' );
	}
	...
	protected function section_content_style() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .durotan-product-shortcode-4 .durotan-product-shortcode__title',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .durotan-product-shortcode-4 .durotan-product-shortcode__title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .durotan-product-shortcode-4 .durotan-product-shortcode__title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .durotan-product-shortcode-4 .woocommerce-product-gallery__wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        $this->add_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .durotan-product-shortcode-4 .entry-summary' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
	...
	protected function section_carousel_style() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .durotan-product-shortcode-4 ul.flex-direction-nav a' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .durotan-product-shortcode-4 ul.flex-direction-nav a' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .durotan-product-shortcode-4 ul.flex-direction-nav a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .durotan-product-shortcode-4 ul.flex-direction-nav a.flex-next' => 'right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .durotan-product-shortcode-4 ul.flex-direction-nav a.flex-prev' => 'left: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .durotan-product-shortcode-4 ul.flex-direction-nav a' => 'top: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
        ...
        if ( empty( $product ) ) {
            ...
            if ( $settings['show_meta'] != '' ) {
				add_action( 'durotan_woocommerce_single_product_summary', 'woocommerce_template_single_meta', 27 );
			}
